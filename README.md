...
- **显示**：字号 16–30 共 8 档可调；每页显示 10 / 20 / 30 / 50 篇可选；顶栏「外观」可切浅色 / 护眼绿 / 深色 / 跟随系统，另有 6 个强调色，弹窗里带实时预览（这三项都存在设备上，不跟账号走）。三档配色都按护眼调过，正文和小字对比度都在 4.5:1 以上。正文里的网址可直接点开。
...
插图片 / 附件、导出 PDF、日历拖拽、回收站、跨设备记住外观和字号、防管理员加密。
